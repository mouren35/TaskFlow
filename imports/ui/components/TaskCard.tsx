...
const TaskCard = React.forwardRef<HTMLDivElement, Props>(({ task, onStart, onComplete }, ref) => {
  ...
  return (
    ...
    >
      <Stack direction="row" justifyContent="space-between" alignItems="center">
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            {task.notes && (
              <Tooltip title={task.notes} arrow placement="bottom-start">
                <Box component="span" sx={{ ml: 1, cursor: "help", textDecoration: "underline dotted" }}>
                  ...
                </Box>
              </Tooltip>
            )}
        ...
        <Chip
          label={
            task.status === "completed" ? "已完成" : task.status === "inProgress" ? "进行中" : "未完成"
          }
          size="small"
          sx={{ fontWeight: 500 }}
        />
